...
public class HEALTH extends Fragment {
    ...
    //set news in recyclerview foe health categories
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_h_e_a_l_t_h, container, false);
        ourcountry = view.findViewById(R.id.healthrecycler);
    ...
    void getnews()
    {
        apputilities.getAppinterface().getNews("in","health",100,"05e52b05f07a45528a86275897f4ebdc").enqueue(new Callback<NewsApiResponse>() {
            @Override
